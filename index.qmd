...
The vessel risk ($R$) to whales is calculated as a simple multiplication of number of whales ($W$) and km of vessel traffic ($V$) (@eq-risk).
...
Finally, we can evaluate the risk reduction of the original Whale Area proposed in the Biological Opinion [@nmfsBiologicalOpinionFederally2020] compared with the newly proposed Whale Area encompassing the wider Gulf of Mexico [@tbl-risk-reduction-by-areas].
