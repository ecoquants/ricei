...
# TODO:
# ck for vestigial branch 1-re-analyze-with-native-vessel-traffic-grid-and-projection in:
# * [new gt tables, pre docx fixes · ecoquants/ricei@7c985bd](https://github.com/ecoquants/ricei/commit/7c985bd56ed7bb646771cbecb0b2faee890683f3#diff-e3f1031c3432f4ea60576aaeab139998a814f42691c957ab49f42c04642f9222)
# 2. check Table 3: Oil & Gas both speeds, divider? update to divide by whole area for given type & speed.
```
...
# Manual docx: mv tbl outside figure table. Reference > Insert Caption. Add Table 1 and Insert Hyperlink to This Document "tbl-whales-by-area" to replace "?@tbl-whales-by-area".
