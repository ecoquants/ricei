...
The Rice's whale (*Balaenoptera ricei*) is endangered within an estimated population size of 51 individuals ([Garrison et al. 2020](https://www.fisheries.noaa.gov/resource/document/abundance-marine-mammals-waters-us-gulf-mexico-during-summers-2017-and-2018)). The Biological Opinion ([NOAA 2020](https://www.fisheries.noaa.gov/resource/document/biological-opinion-federally-regulated-oil-and-gas-program-activities-gulf-mexico)) based on original distribution ([Roberts et al. 2016](https://doi.org/10.1038/srep22615)) has been superseded by newer distribution ([Litz et al. 2022](https://www.ncei.noaa.gov/access/metadata/landing-page/bin/iso?id=gov.noaa.nodc:0243469)) showing range expansion into western Gulf of Mexico.
