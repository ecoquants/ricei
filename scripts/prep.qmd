...
```{r}
#| label: risk_gt10_reduction_by_areas_csv
...
write_csv(d, risk_gt10_reduction_by_areas_csv)
```

```{r}
#| label: risk_gt01_reduction_by_areas_csv
...
write_csv(d, risk_gt01_reduction_by_areas_csv)
```
